...
void gfxprintw( int yy , int xx , char *mystring) 
{
...
int main () 
{
	...
	while( gameover == 0 ) {		
		...
		*/
                       ...
                       if (text[0]=='l') {    gfxprintw( 250, 250, "line" );   } 

                       else if (text[0]=='u') { gfxprintw( 50, 50, "hello (u)" );   } 
                       else if (text[0]=='d') { gfxprintw( 75, 75, "hello (d)" );   } 
